...
public class PNRValidatorTest {
    ...
    @BeforeEach
    public void init() {
        validator = new PNRValidator();
    }

    @Test
    public void isPNRValid_results_true() {
    ...
    @Test
    public void isPNRValid_results_false() {
        String test = "Abhishek, Kumar, @ABC12, F, 2019-07-31, 2, 2019-05-21,abhishek@zzzcom, 129876543210, Economy1";
        boolean result = validator.validate(test.split(COMMA));
    ...
    public void errorMessage() {
        Assertions.assertEquals(validator.errorMessage(), "PNR is InValid");
    }
}
